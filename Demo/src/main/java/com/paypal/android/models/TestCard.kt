...
data class TestCard(val id: String, val name: String, val card: Card) : Parcelable {
    ...
    companion object {
        ...
        fun byId(testCardId: String): TestCard? = when (testCardId) {
            VISA_VAULT_WITH_PURCHASE_NO_3DS.id -> VISA_VAULT_WITH_PURCHASE_NO_3DS
            VISA_NO_3DS_1.id -> VISA_NO_3DS_1
            VISA_NO_3DS_2.id -> VISA_NO_3DS_2
            VISA_3DS_SUCCESSFUL_AUTH.id -> VISA_3DS_SUCCESSFUL_AUTH
            VISA_3DS_FAILED_SIGNATURE.id -> VISA_3DS_FAILED_SIGNATURE
            VISA_3DS_FAILED_AUTHENTICATION.id -> VISA_3DS_FAILED_AUTHENTICATION
            VISA_3DS_PASSIVE_AUTHENTICATION.id -> VISA_3DS_PASSIVE_AUTHENTICATION
            VISA_3DS_TRANSACTION_TIMEOUT.id -> VISA_3DS_TRANSACTION_TIMEOUT
            VISA_3DS_NOT_ENROLLED.id -> VISA_3DS_NOT_ENROLLED
            VISA_3DS_AUTH_SYSTEM_UNAVAILABLE.id -> VISA_3DS_AUTH_SYSTEM_UNAVAILABLE
            VISA_3DS_AUTH_ERROR.id -> VISA_3DS_AUTH_ERROR
            VISA_3DS_AUTH_UNAVAILABLE.id -> VISA_3DS_AUTH_UNAVAILABLE
            VISA_3DS_MERCHANT_BYPASSED_AUTH.id -> VISA_3DS_MERCHANT_BYPASSED_AUTH
            VISA_3DS_MERCHANT_INACTIVE.id -> VISA_3DS_MERCHANT_INACTIVE
            VISA_3DS_CMPI_LOOKUP_ERROR.id -> VISA_3DS_CMPI_LOOKUP_ERROR
            else -> null
        }
    }
