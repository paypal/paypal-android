...
enum class Feature(@StringRes val stringRes: Int, val routeName: String) {
    ...
    PAYPAL_CHECKOUT(R.string.feature_paypal_checkout, DemoAppDestinations.PAYPAL_CHECKOUT),
    PAYPAL_VAULT(R.string.feature_paypal_vault, DemoAppDestinations.PAYPAL_VAULT),
    ...
    GOOGLE_PAY(R.string.feature_google_pay, DemoAppDestinations.GOOGLE_PAY)
}
