...
class ThreeDSecureAPIRequestFactoryUnitTest {

    private val orderID = "sample-order-id"

    private lateinit var sut: ThreeDSecureAPIRequestFactory

    @Before
    fun beforeEach() {
        sut = ThreeDSecureAPIRequestFactory()
    }

    @Test
    fun `it builds a confirm payment source request with SCA verification`() {
        val card = Card(
