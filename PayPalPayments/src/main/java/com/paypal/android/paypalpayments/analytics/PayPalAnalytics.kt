...
internal class PayPalAnalytics(private val analyticsService: AnalyticsService) {

    fun notify(event: PayPalEvent, params: AnalyticsEventParams, errorDescription: String? = null) {
...
private fun AnalyticsEventParams.toAnalyticsEventData(
    orderId: String? = null,
    errorDescription: String? = null,
) = AnalyticsEventData(
    orderId = orderId,
    ...
    linkType = linkType?.analyticsValue,
)
