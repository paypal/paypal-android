...
class RestClientUnitTest {
    ...
    private val sandboxConfig = CoreConfig("fake-sandbox-client-id", Environment.SANDBOX, "fake-merchant-id")
    private val liveConfig = CoreConfig("fake-live-client-id", Environment.LIVE, "fake-merchant-id")
